...
const initiateTransfer = async (data) =>
  paystackInstance.post("/transfer", data);

const sendOTP = async (data) =>
  paystackInstance.post("/charge/submit_otp", data);
...
const generateCheckoutUrl = async (data) =>
  paystackInstance.post("/transaction/initialize", data);
